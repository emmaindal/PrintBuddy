        ...
        return (
            <div className="col s12 m10 offset-m1 l6">
                <ul className="collection with-header" id="pendingbuddieslist">
                    <li className="collection-header"><h5>Pick a Printbuddy for the job!</h5><a onClick={this.popCancelModal} className="red lighten-2 waves-effect waves-light btn cancel-button">Cancel</a></li>

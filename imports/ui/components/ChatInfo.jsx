        ...
        return (
            <div className="chat-info">
                <ul className={this.chatInfoWrapperStyle()}>
                    ...
                    <li className="collection-item"><span>Color:</span> {request.needColor ? i18n.__('other.yes') : i18n.__('other.no')} </li>
                    ...
                    <li className="collection-item"><span>Delivery:</span> {request.delivery ? i18n.__('other.yes') : i18n.__('other.no')} </li>
                    <li className="collection-item">

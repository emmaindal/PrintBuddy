            ...
            <div className="container">
                ...
                <div className="row chat-row">
                    ...
                    <div className="col s12 m10 l5 offset-m1  offset-l1 chat-holder">
                        <ChatHolder userId={this.props.userId} chat={this.props.chat} request={this.props.request} onClick={this.props.handleDownload.bind(this)} onSubmit={this.props.onSubmit}/>
                    </div>
